...
const assetMap = [
  // Brand logos
  {
    local: "attached_assets/Seed Financial Logo - Light Mode.png",
    remote: "logos/brand/seed-financial-light.png",
  },
  {
    local: "attached_assets/Seed Financial Logo - Dark Mode.png",
    remote: "logos/brand/seed-financial-dark.png",
  },

  // SEEDOS dashboard logos
  {
    local: "client/src/assets/SEEDOS -SALES- light bg.png",
    remote: "logos/seedos/sales-light.png",
  },
  { local: "client/src/assets/SEEDOS -SALES- dark bg.png", remote: "logos/seedos/sales-dark.png" },
  {
    local: "client/src/assets/SEEDOS -SERVICE- light bg.png",
    remote: "logos/seedos/service-light.png",
  },
  {
    local: "client/src/assets/SEEDOS -SERVICE- dark bg.png",
    remote: "logos/seedos/service-dark.png",
  },
  {
    local: "client/src/assets/SEEDOS -ADMIN- light bg.png",
    remote: "logos/seedos/admin-light.png",
  },
  ...
  {
    local: "client/src/assets/SEEDCADENCE light bg.png",
    remote: "logos/apps/seedcadence-light.png",
  },
...
async function uploadToProject(env: "dev" | "prod") {
  ...
  if (!project.key) {
    ...
    console.error(
      `   Add ${env === "dev" ? "SUPABASE_DEV_SERVICE_ROLE_KEY" : "SUPABASE_SERVICE_ROLE_KEY"} to .env`
    );
...
async function main() {
  ...
  const envsToUpload: Array<"dev" | "prod"> = targetEnv ? [targetEnv] : ["dev", "prod"];
  ...
  if (results.dev.success > 0 || results.prod.success > 0) {
    ...
    if (results.dev.success > 0) {
      ...
      console.log(
        `   VITE_SUPABASE_STORAGE_URL=${projects.dev.url}/storage/v1/object/public/${BUCKET_NAME}\n`
      );
    }
    ...
    if (results.prod.success > 0) {
      ...
      console.log(
        `   VITE_SUPABASE_STORAGE_URL=${projects.prod.url}/storage/v1/object/public/${BUCKET_NAME}\n`
      );
    }
