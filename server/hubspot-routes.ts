...
export function registerHubspotRoutes(app: Express) {
   ...
   * Action: hubspot.contacts.read
   * Verify if a contact exists in HubSpot by email
   */
  app.post(
    "/api/hubspot/verify-contact",
    requireAuth,
    requirePermission("hubspot.contacts.read", "department"),
    async (req, res) => {
      try {
   ...
   * Action: hubspot.contacts.read
   * Search for contacts in HubSpot by name or email
   */
  app.post(
   ...
   * Action: hubspot.sync.write
   * Queue a quote sync to HubSpot (with fallback to direct sync)
   */
  app.post(
    "/api/hubspot/queue-sync",
    requireAuth,
    requirePermission("hubspot.sync.write", "department"),
    async (req, res) => {
      try {
   ...
   * Action: hubspot.queue.read
   * Get the current status of the HubSpot sync queue
   */
  app.get(
    "/api/hubspot/queue-status",
    requireAuth,
    requirePermission("hubspot.queue.read", "system"),
    async (_req, res) => {
      try {
   ...
   * Debug endpoint to view HubSpot products
   */
  app.get(
    "/api/hubspot/debug/products",
    requireAuth,
   ...
   * Action: diagnostics.view
   * Check HubSpot API health status
   */
  app.get(
    "/api/hubspot/health",
    requireAuth,
   ...
   * Action: hubspot.queue.manage
   * Clean up stale items in the HubSpot sync queue
   */
  app.post(
    "/api/hubspot/cleanup-queue",
    requireAuth,
    requirePermission("hubspot.queue.manage", "system"),
    async (_req, res) => {
      try {
  ...
  /**
   * POST /api/hubspot/diagnostics/create
   * Action: diagnostics.view
   * Preview quote creation data for HubSpot (dry-run)
   */
  app.post(
    "/api/hubspot/diagnostics/create",
    requireAuth,
    requirePermission("diagnostics.view", "system"),
    async (req, res) => {
      try {
  ...
  /**
   * POST /api/hubspot/diagnostics/update
   * Action: diagnostics.view
   * Preview quote update data for HubSpot (dry-run)
   */
  app.post(
    "/api/hubspot/diagnostics/update",
    requireAuth,
    requirePermission("diagnostics.view", "system"),
    async (req, res) => {
      try {
  ...
  /**
   * GET /api/hubspot/diagnostics/create
   * Action: diagnostics.view
   * GET variant of diagnostics/create for convenience
   */
  app.get(
    "/api/hubspot/diagnostics/create",
    requireAuth,
  ...
  /**
   * GET /api/hubspot/diagnostics/update
   * Action: diagnostics.view
   * GET variant of diagnostics/update for convenience
   */
  app.get(
    "/api/hubspot/diagnostics/update",
    requireAuth,
  ...
  /**
   * POST /api/hubspot/retry-job
   * Action: hubspot.queue.manage
   * Retry a failed HubSpot sync job (admin only)
   */
  app.post(
    "/api/hubspot/retry-job",
    requireAuth,
    requirePermission("hubspot.queue.manage", "system"),
    async (req, res) => {
      try {
   ...
   * Action: hubspot.queue.read
   * Get metrics and statistics for the HubSpot sync queue
   */
  app.get(
    "/api/hubspot/queue-metrics",
    requireAuth,
    requirePermission("hubspot.queue.read", "system"),
    async (_req, res) => {
      try {
   ...
   * Action: hubspot.sync.write
   * Schedule a HubSpot sync operation
   */
  app.post(
    "/api/hubspot/schedule-sync",
    requireAuth,
    requirePermission("hubspot.sync.write", "department"),
    async (req, res) => {
      try {
   ...
   * Action: hubspot.sync.write
   * Legacy direct push to HubSpot via unified path
   */
  app.post(
   ...
   * Action: hubspot.sync.write
   * Legacy direct update to HubSpot via unified path
   */
  app.post(
