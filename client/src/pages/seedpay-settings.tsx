    ...
    <div className="min-h-screen bg-gradient-to-br from-[#253e31] to-[#75c29a]">
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/80 mt-1">Read-only diagnostics for SeedPay. Full configuration to follow.</p>
        </div>
              ...
              {summary ? (
                <div className="text-sm text-foreground grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="font-semibold">${summary.total_commissions?.toLocaleString?.() ?? 0}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="font-semibold">
                      {summary.period_start ? new Date(summary.period_start).toLocaleDateString() : '—'}
                      {' '}–{' '}
          ...
          {!isAdmin && (
            <Card className="border shadow-md">
              ...
              <CardContent className="text-sm text-muted-foreground">
                This area is visible to admins only. You have limited visibility.
              </CardContent>
            </Card>
          )}
        </div>
