    ...
    <div className="min-h-screen bg-gradient-to-br from-[#253e31] to-[#75c29a] flex">
      ...
      <div className="flex-1 ml-64">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-4 gap-6">
            <Card className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 shadow-lg hover:shadow-xl transition-shadow cursor-pointer" onClick={() => { console.log('Stripe card clicked'); setLocation('/stripe-dashboard'); }}>
