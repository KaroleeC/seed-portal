...
export default function ServiceDashboard() {
  ...
  const [currentTasks] = useState([
    {
      id: "1",
      title: "Review TechFlow Q4 Financials",
    ...
    {
      id: "2",
      title: "Prepare Wellness Hub Tax Documents",
    ...
    {
      id: "3",
      title: "Client Onboarding Call - Marina Cafe",
      client: "Marina Cafe",
      priority: "normal",
      dueTime: "11:00 AM",
      progress: 0,
    ...
    {
      id: "4",
      title: "Monthly Bookkeeping - RetailCorp",
      client: "RetailCorp",
      priority: "normal",
      dueTime: "Tomorrow",
      progress: 90,
  ...
  const [clickupTasks] = useState([
    {
      id: "1",
      name: "Monthly Bookkeeping - TechFlow",
      assignee: "Sarah Chen",
      status: "In Progress",
      dueDate: "2025-01-10",
      project: "Bookkeeping",
    ...
    {
      id: "2",
      name: "Tax Preparation - Wellness Hub",
    ...
    {
      id: "3",
      name: "Cleanup Project - Marina Cafe",
      assignee: "Sarah Chen",
      status: "Planning",
      dueDate: "2025-01-15",
      project: "Cleanup",
