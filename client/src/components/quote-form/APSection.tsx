...
import { Receipt, Building2, CreditCard, CheckCircle, ChevronDown, ChevronUp } from "lucide-react";
...
export default function APSection({ form }: APSectionProps) {
  ...
  // Only show if AP service is selected
  if (!form.watch("serviceApArService")) return null;
    ...
    <SurfaceCard className="p-6 mb-8">
      ...
      >
        <div className="flex items-center justify-between group p-3 -m-3 rounded-lg transition-colors">
          <h3 className="text-xl font-semibold text-foreground">AP Service Details</h3>
