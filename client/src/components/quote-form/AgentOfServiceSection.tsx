...
import { Building2, FileText, DollarSign, CheckCircle, ChevronDown, ChevronUp } from "lucide-react";
...
export default function AgentOfServiceSection({ form }: AgentOfServiceSectionProps) {
  ...
  const _totalFee = baseFee + additionalStatesFee + complexCaseFee; // Reserved for future display
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground">
                  Entity & Filing Admin, Tax & Compliance Admin, Banking & Account Setup, Misc.
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="mt-4">
                    <Card className="p-4">
                      ...
                      <div className="mt-3 text-sm text-muted-foreground">
                        <p>
                          Each additional state or entity where there is an Agent of Service
                          designation need beyond the primary registration.
                        </p>
                      </div>
                    </Card>
                  </div>
