...
export function CfoAdvisorySection({ control, form }: CfoAdvisorySectionProps) {
  ...
  const bundleOptions = [
    { hours: 8, rate: 295, total: 2360, savings: "vs $300/hr", hubspotId: '28928008785' },
    { hours: 16, rate: 290, total: 4640, savings: "vs $300/hr", hubspotId: '28945017959' },
    { hours: 32, rate: 285, total: 9120, savings: "vs $300/hr", hubspotId: '28960863883' },
    { hours: 40, rate: 280, total: 11200, savings: "vs $300/hr", hubspotId: '28960863884' }
  ];
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-semibold text-gray-800">CFO Advisory Service Details</h3>
          ...
          <FormItem>
            ...
            <FormControl>
              ...
              >
                ...
                <Card className={`cursor-pointer transition-all ${currentType === 'pay_as_you_go' ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:shadow-md'}`}>
                        ...
                        <Label htmlFor="pay_as_you_go" className="cursor-pointer">
                          ...
                          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className="font-medium text-yellow-800">8-Hour Deposit Required</span>
                            </div>
                ...
                <Card className={`cursor-pointer transition-all ${currentType === 'bundled' ? 'ring-2 ring-purple-500 bg-purple-50' : 'hover:shadow-md'}`}>
                      ...
                      <div className="flex-1">
                        <Label htmlFor="bundled" className="cursor-pointer">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-semibold text-gray-800">Prepaid Hour Bundles</span>
                                  ...
                                  <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-right">
                                      ...
                                      <div className="text-xs text-green-600 font-medium">
                                        Save ${((300 - bundle.rate) * bundle.hours).toLocaleString()}
                                      </div>
                                    </div>
                                  </div>
                                </div>
