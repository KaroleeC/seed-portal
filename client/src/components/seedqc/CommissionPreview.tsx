    ...
    <SurfaceCard className="p-6 mb-8">
      <div className="pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-2xl font-bold text-foreground">Commission Preview</CardTitle>
            <p className="text-sm text-muted-foreground mt-1">Your earnings from this quote</p>
          </div>
        </div>
      </div>
      <div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-lg p-6 border bg-muted">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-foreground">Month 1 Commission</h3>
            ...
            <div className="space-y-2">
              {totalSetupFee > 0 && (
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Setup Fee (20%):</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Monthly Fee (40%):</span>
                <span className="font-semibold text-foreground">
          ...
          <div className="rounded-lg p-6 border bg-muted">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-foreground">Ongoing Monthly</h3>
              <div className="text-2xl font-bold text-green-600">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Monthly Fee (10%):</span>
                <span className="font-semibold text-foreground">
                  {`$${ongoingMonthlyCommission.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                </span>
              </div>
              <div className="text-xs text-muted-foreground">Months 2-12 (11 payments)</div>
              <div className="border-t pt-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-semibold text-muted-foreground">
                    Total Ongoing:
        ...
        <div className="mt-6 rounded-lg p-6 border bg-muted">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-xl font-bold text-foreground">Total First Year Commission</h3>
